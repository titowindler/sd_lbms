              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="../../img/<?php echo ($row['book_image']);?>" width="200" height="200" alt="Template Demo Image"></td>
                    <td><?php echo $row['book_name']?></td>
                    <td><?php echo $row['borrower_name']?></td>
                    <td><?php echo $row['borrower_position']?></td>
                    <td><?php echo $row['borrowed_date']?></td>
                    <td><?php echo $row['return_date']?></td>
                      <td>
                     <?php if($row['borrowed_status'] == 0 ) { ?> 
                        <a href="../../controller/borrow_book.php?approve=<?php echo $row['borrowed_id']?>" class="btn btn-primary">Approved Request</a>
                      <?php } else { ?>
                        <p class="text-success">Approve Borrowed Book Request</p>  
                      <?php } ?>  
                      </td>
                  </tr>
